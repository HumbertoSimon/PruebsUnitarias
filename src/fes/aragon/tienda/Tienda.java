...
public class Tienda {
	...
	public camisa CMC() {
		...
		CMC.setDesc("Camisa Manga Corta");
		CMC.setId(1);
		CMC.setPrecio(190);
	...
	public camisa CCML() {
		...
		CCMC.setDesc("Camisa Casual Manga Larga");
		CCMC.setId(2);
		CCMC.setPrecio(230);
	...
	public camisa CFML() {
		...
		CFML.setDesc("Camisa Formal Manga Larga");
		CFML.setId(3);
		CFML.setPrecio(310);
	...
	public void AñadirCarrito(camisa c) {
		carrito.add(c);
	}
	
	public void AñadirCarrito(camisa c, int num) {
		for (int i = 0; i < num; i++) {
			carrito.add(c);
		}
	}
	...
	public void Verificador() {
		...
		if (3 <= numCamis && numCamis <= 5) {
			...
			System.out.println("Te otorgamos %5 de descuento");
			System.out.println("El descuento sera de: $" + TotalPagar * 0.05);
			...
			System.out.println("Te otorgamos %8 de descuento");
			System.out.println("El descuento es de: $" + TotalPagar * 0.08);
